...
public class UnwrappingRepositoryInvokerFactoryUnitTests {
	...
	private void assertQueryValueForSource(Object source, Matcher<Object> value) {
		...
		when(invoker.invokeQueryMethod(method, parameters, null, null)).thenReturn(source);
		assertThat(factory.getInvokerFor(Object.class).invokeQueryMethod(method, parameters, null, null), value);
	}
}

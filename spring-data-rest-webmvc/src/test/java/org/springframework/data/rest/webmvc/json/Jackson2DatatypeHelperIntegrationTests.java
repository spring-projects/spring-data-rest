...
public class Jackson2DatatypeHelperIntegrationTests {
	...
	public void configuresHIbernate4ModuleToLoadLazyLoadingProxies() throws Exception {
		...
		BeanWrapper<Order> wrapper = BeanWrapper.create(orders.findOne(this.order.getId()), null);

		assertThat(objectMapper.writeValueAsString(wrapper.getProperty(property)), is(not("null")));
	}
}

...
public class Patch {
	 ...
	 * @throws PatchException if there are any errors while applying the patch.
	 */
	public <T> T apply(T in, Class<T> type, EvaluationContext context) throws PatchException {
	 ...
	 * @throws PatchException if there are any errors while applying the patch.
	 */
	public <T> List<T> apply(List<T> in, Class<T> type, EvaluationContext context) throws PatchException {
